...
O restante do artigo está organizado como se segue: a seção 2, Revisão Teórica, aborda os conceitos de Triagem, Sistema Manchester e Redes Neurais, além dos trabalhos relacionados. A seção 3, Metodologia, classifica a pesquisa e detalha os procedimentos metodológicos empregados. A seção 4, RNA na Classificação do Grau de Urgência de Pacientes, apresenta a proposta da rede neural para solução do problema descrito. Finalmente, a seção 5, Conclusão, discute os resultados alcançados, limitações encontradas, perspectivas futuras e conclusões finais. 
