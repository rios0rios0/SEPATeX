...
Esta pesquisa foi conduzida observando informações coletadas de um pequeno \emph{software} criado pelo autor, que atende ao critério de conhecimento de sua estrutura e fluxo, e em seguida, de desconhecimento das mesmas condições. Isto acontece pois este ``alvo'', compartilha da mesma região de memória virtual que o \emph{software} atacante; e no segundo momento, não compartilha da mesma região de memória que o atacante. E, nestas duas situações, o autor usará endereços de memória conhecidos e desconhecidos, respectivamente.
