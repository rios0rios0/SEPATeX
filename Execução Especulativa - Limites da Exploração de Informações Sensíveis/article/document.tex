...
\usepackage[font=footnotesize,skip=\baselineskip]{caption}
% ------------------------------------------------------------------------
...
\hypersetup{
	...
	pdfkeywords={execução}{especulativa}{\emph{Spectre}}{limites}{exploração}{informações}, 
